<div>
    <form action="#" wire:submit.prevent="storePost">
        <div class="mb-3">
            ...
            <textarea name="body" id="body" cols="30" rows="3" class="w-full border-2 border-gray-200 rounded-lg @error('body') border-pink-500 @enderror" placeholder="Share something..." wire:model.defer="body"></textarea>
